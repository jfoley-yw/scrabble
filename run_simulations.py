...
def main():
    ...
    for i in range(n):
        ...
        player0 = Player(ShortMonteCarloSimStrategy(num_rollouts=1500), name="Short Monte Midgame")
        # player0 = Player(MCTSStrategy(num_rollouts=2000), name="MCTS strat")
...
def main2():
    ...
    for i in range(n):
        # player0 = Player(midgame_strategy=BaselineStrategy(), endgame_strategy=ABStrategy(), name="AB Pruning Endgame")
        # player1 = Player(ShortMonteCarloSimStrategy(num_rollouts=10000), name="Short Monte Midgame")
        player1 = Player(MCTSStrategy(num_rollouts=2000), name="MCTS strat")
        player0 = Player(RandomStrategy(), name="Random")
        # player0 = Player(BaselineStrategy(), name="Greedy Endgame")
        # player0 = Player(BaselineStrategy(), name="Greedy Endgame")
        p0score, p1score, letters_to_points, letters_to_plays = Simulation.simulate_game(player0, player1)
...
if __name__ == "__main__":
    ...
    # player00scores, player11scores, p00wins, p11wins = main2()
    ...
    # print('PLAYER 1: \n', player00scores)
    # print('PLAYER 2: \n', player11scores)
    # print('AVERAGE', sum(player00scores) / len(player00scores),":", sum(player11scores) / len(player11scores))
    # print('TOTAL WINS: ', p00wins, ":", p11wins)
